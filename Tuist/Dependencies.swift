...
let dependencies = Dependencies(
    ...
    swiftPackageManager: [
        ...
        .remote(url: "https://github.com/SvenTiigi/YouTubePlayerKit.git", requirement: .upToNextMajor(from: "1.3.0")),
        ...
        .remote(url: "https://github.com/ngochiencse/HPParallaxHeader", requirement: .upToNextMajor(from: "1.1.0"))
    ],
    platforms: [.iOS]
)
