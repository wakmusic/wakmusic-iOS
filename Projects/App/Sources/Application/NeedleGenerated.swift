...
extension AppComponent: Registration {
    public func registerItems() {
        ...
        localTable["fetchNewSongUseCase-any FetchNewSongUseCase"] = { [unowned self] in self.fetchNewSongUseCase as Any }
        ...
        localTable["remoteQuestionDataSource-any RemoteQnaDataSource"] = { [unowned self] in self.remoteQuestionDataSource as Any }
        localTable["questionRepository-any QnaRepository"] = { [unowned self] in self.questionRepository as Any }
