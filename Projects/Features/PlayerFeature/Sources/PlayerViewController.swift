...
private extension PlayerViewController {
    ...
    private func configureThumbnail() {
        thumbnailImageView.snp.makeConstraints {
            ...
            $0.horizontalEdges.equalTo(view.snp.horizontalEdges).inset(UIEdgeInsets(top: 0, left: 25, bottom: 0, right: 25))
    ...
    private func configurePlayTimeSlider() {
        playTimeSlider.snp.makeConstraints {
            ...
            $0.horizontalEdges.equalTo(view.snp.horizontalEdges).inset(UIEdgeInsets(top: 0, left: 20, bottom: 0, right: 20))
        }
    }
