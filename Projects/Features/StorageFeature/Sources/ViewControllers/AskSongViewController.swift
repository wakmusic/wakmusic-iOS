...
extension AskSongViewController {
    private func configureHeaderUI() {
        ...
        redirectWebButton.setAttributedTitle(
    ...
    private func configureUI() {
        ...
        for i in 0 ..< 4 {
            ...
            if i < 3 {
                textFields[i].attributedPlaceholder = NSAttributedString(
                    string: placeHolder,
    ...
    private func bindRx() {
        ...
        let mergeObservable1 = Observable.merge(
            tfEditingDidBegin1.map { UIControl.Event.editingDidBegin },
        ...
        let mergeObservable2 = Observable.merge(
            tfEditingDidBegin2.map { UIControl.Event.editingDidBegin },
        ...
        let mergeObservable3 = Observable.merge(
            tfEditingDidBegin3.map { UIControl.Event.editingDidBegin },
