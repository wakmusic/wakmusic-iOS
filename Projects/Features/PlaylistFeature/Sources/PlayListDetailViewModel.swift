...
public final class PlayListDetailViewModel: ViewModelType {
    ...
    var editPlayListUseCase: UpdatePlaylistUseCase!
    ...
    public init(
        ...
        editPlayListUseCase: UpdatePlaylistUseCase,
    ...
    public func transform(from input: Input) -> Output {
        ...
        input.tapRemoveSongs
            ...
            .subscribe(onNext: { model in
                output.showErrorToast.accept((model.status == 200) ? BaseEntity(
                    status: 200,
                    description: "리스트에서 삭제되었습니다."
                ) : model)
                output.refreshPlayList.accept(())
