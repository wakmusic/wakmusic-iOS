...
final class MyPlaylistHeaderView: UIView {
    ...
    let titleLabel: WMLabel = WMLabel(text: "테스트", textColor: DesignSystemAsset.BlueGrayColor.blueGray900.color ,font: .t3(weight: .bold)).then {
        $0.numberOfLines = 0
    }
    
    let countLabel: WMLabel = WMLabel(text: "3곡", textColor: DesignSystemAsset.BlueGrayColor.blueGray900.color.withAlphaComponent(0.6) ,font: .t6_1(weight: .light))
