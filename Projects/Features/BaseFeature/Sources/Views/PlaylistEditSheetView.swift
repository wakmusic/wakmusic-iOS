...
public class PlaylistEditSheetView: UIView {
    ...
    private let editButton: VerticalAlignButton = VerticalAlignButton(title: "편집", image: DesignSystemAsset.PlayListEdit.playlistEdit.image, spacing: .zero, textColor: .white)
    
    private let shareButton: VerticalAlignButton = VerticalAlignButton(title: "공유하기", image: DesignSystemAsset.PlayListEdit.playlistShare.image, spacing: .zero, textColor: .white)
