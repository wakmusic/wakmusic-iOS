...
public final class AfterSearchComponent: Component<AfterSearchDependency> {
    public func makeView() -> AfterSearchViewController {
        return AfterSearchViewController.viewController(afterSearchContentComponent: dependency.afterSearchContentComponent,containSongsComponent:dependency.containSongsComponent, viewModel: .init(fetchSearchSongUseCase: dependency.fetchSearchSongUseCase))
