...
extension TmpViewController {
    ...
    private func configureSection(_ layout: Section) -> NSCollectionLayoutSection {
        ...
        switch layout {
            ...
            case .mid:
                ...
                let groupSize = NSCollectionLayoutSize(widthDimension: .absolute(groupWidth), heightDimension: .absolute(groupeight))
                group = NSCollectionLayoutGroup.horizontal(layoutSize: groupSize,subitems: [item])
    ...
    private func configureDataSource() {
        ...
        let cellRegistration = UICollectionView.CellRegistration<YoutubeThumbnailView, DataSource> { (cell, indexPath, item) in
        ...
        snapshot.appendItems([.recommand(model2: Model2(title2: "123")),.recommand(model2: Model2(title2: "456")),.recommand(model2: Model2(title2: "4564")),.recommand(model2: Model2(title2: "4516")),], toSection: .mid)
        snapshot.appendItems([.popularList(model: Model(title: "Hello1")),.popularList(model: Model(title: "Hello2")),.popularList(model: Model(title: "Hello3")),], toSection: .bottom)
