    ...
    public func transform(from input: Input) -> Output {
        ...
        input.indexPath
            ...
            .map { [weak self] indexPath, dataSource -> [SearchSectionModel] in
                ...
                var newModel = dataSource
                newModel[indexPath.section].items[indexPath.row].isSelected = !newModel[indexPath.section]
                    .items[indexPath.row].isSelected
        ...
        NotificationCenter.default.rx.notification(.selectedSongOnSearch)
            ...
            .map { (song: SongEntity, dataSource: [SearchSectionModel]) -> [SearchSectionModel] in
                ...
                models[indexPath.section].items[indexPath.row].isSelected = !models[indexPath.section]
                    .items[indexPath.row].isSelected
                return models
            }
            .bind(to: output.dataSource)
